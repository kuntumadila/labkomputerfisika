    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <?php
                if(isset($_GET['praktikum']) && isset($_GET['no']))
                {
                    $x = $_GET['praktikum'];
                    $no = $_GET['no'];
                ...
                ?> 
                    <div class="col-lg-12">
                        <h1 class="page-header">Input Data Tugas Praktikum</h1>
                        <form role="form" name="form_input" method="post" action="store.php">
                            <div class="form-group form-inline">
                                <label>Praktikum : </label>
                                <input class="form-control" name="prak" value="<?php echo $_GET['praktikum'];?>" type="text" readonly="" required="">
                            </div>
                            <div class="form-group">
                                <label>No Tugas : </label>
                                <input class="form-control" name="no" value="<?php echo $_GET['no'];?>"  readonly="" type="number" required="">
                            </div>
                            ...
                            $kelompok="";
                            $prak=$_GET['praktikum'];
                            $praktikumSelectt = mysql_query("select * from praktikum where Id_Praktikum = '$prak'");
                ...
                <?php } else { ?>
                    <div class="col-lg-6">
                        ...
                        <form role="form" name="pilih" method="get" action="">
                            ...
                            <div class="form-group">
                                <label>No Tugas : </label>
                                <input class="form-control" name="no" type="number" required="">
                            </div>
                            <button type="submit" class="btn btn-default">Submit</button>
                        </form>
                    </div>
