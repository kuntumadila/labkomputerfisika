    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tambah Data Praktikum</h1>
                        <form role="form" name="form_input" method="post" action="store.php">
                            ...
                            <div class="form-group">
                                <label>Modul : </label>
                                <input class="form-control" name="modul" type="number" required="">
                            </div>
                            <div class="form-group">
                                <label>Semester: </label>
                                <select class="form-control" name="semester" required="">
                                    <?php
                                    $z = mysql_query("select * from jenis_praktikum");
                                    while ($row = mysql_fetch_array($z)) {
                                        echo '<option value="'.$row['Id_Jenis'].'">'.$row['mata_kuliah'].'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
