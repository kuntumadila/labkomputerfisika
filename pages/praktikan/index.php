                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        if (isset($_GET['err']))
                        {
                            ...
                            if ($_GET['err']=="inp")
                            {
                                echo "Gagal Menginputkan Semua Data";
                            }
                        ...
                        ?>  
                        <h1 class="page-header">Data Praktikan</h1>
                        <select class="form-control" name="menu" onchange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            while ($row = mysql_fetch_array($query)) {
                                echo '<option value="../praktikan/index.php?id='.$row['Id_Jadwal'].'">'.$row['Id_Jadwal']."</option>";
                            }
                            ?>
                        </select>
                        <br>
                        ...
                        ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    $x = $_GET['id'];
                                    $asisten = mysql_query("select * from praktikan where Kelompok ='$x'");
                                    while ($row = mysql_fetch_array($asisten)) {
                                        echo "<tr>";                                
                                        echo "<td>".$row['Nim']."</td>";                                
                                        echo "<td>".$row['Nama']."</td>";                                
                                        echo '<td><a href="edit.php?id='.$row['Nim'].'"> Edit </a>';                                
                                        echo ' - ';                                
                                        echo '<a href="delete.php?id='.$row['Nim'].'&kel='.$x.'"> Delete </a></td>';                                
                                        echo "</tr>";                                
                                    }   
                                    ?>
