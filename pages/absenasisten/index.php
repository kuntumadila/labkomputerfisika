                    ...
                    <div class="col-lg-4">
                        ...
                        <select class="form-control" name="menu" onchange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            while ($row = mysql_fetch_array($query)) {
                                echo '<option value="../absenasisten/index.php?id='.$row['Id_Praktikum'].'">'.$row['Id_Praktikum']."</option>";
                            }
                            ?>
                        </select>
                        <br>
                        ...
                        ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $absen = mysql_query("select * from asisten right join absen_asisten on absen_asisten.Id_Asisten = asisten.Id_Asisten where absen_asisten.Id_Praktikum = '$x'");
                                    while ($row = mysql_fetch_array($absen)) {
                                        echo "<tr>";                                
                                        echo "<td>".$row['Id_Asisten']."</td>";                                
                                        echo "<td>".$row['Nama']."</td>";
