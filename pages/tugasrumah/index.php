                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        if (isset($_GET['err']))
                        {
                            ...
                            if ($_GET['err']=="inp")
                            {
                                echo "Gagal Menginput Semua Data";
                            }
                        ...
                        <select class="form-control" name="menu" onchange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            while ($row = mysql_fetch_array($query)) {
                                echo '<option value="../tugasrumah/index.php?id='.$row['Id_Praktikum'].'">'.$row['Id_Praktikum']."</option>";
                            }
                            ?>
                        </select>
                        <br>
                        ...
                        ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    echo '</div>';
                                    $absen = mysql_query("select * from praktikan right join tugas_rumah on tugas_rumah.Nim = praktikan.Nim where tugas_rumah.Id_Praktikum = '$x'");
                        ...
                        ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    echo "Modul = ".$detailPraktikum['Modul'];
                                    echo '</div>';
                                    $absen = mysql_query("select * from praktikan right join tugas_rumah on tugas_rumah.Nim = praktikan.Nim where tugas_rumah.Id_Praktikum = '$x'  and status = 'disetujui'" );
                                    while ($row = mysql_fetch_array($absen)) {
                                        echo "<tr>";                                
                                        echo "<td>".$row['Nim']."</td>";                                
                                        echo "<td>".$row['Nama']."</td>";                                
