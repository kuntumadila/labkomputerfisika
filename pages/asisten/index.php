            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        ?>  
                        <h1 class="page-header">Data Asisten</h1>
                        <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $asisten = mysql_query("select * from asisten");
                                    while ($row = mysql_fetch_array($asisten)) {
                                        echo "<tr>";                                
                                        echo "<td>".$row['Id_Asisten']."</td>";                                
                                        echo "<td>".$row['Nama']."</td>";                                
                                        echo '<td><a href="edit.php?id='.$row['Id_Asisten'].'"> Edit </a>';                                
                                        echo ' - ';                                
                                        echo '<a href="delete.php?id='.$row['Id_Asisten'].'"> Delete </a></td>';                                
                                        echo "</tr>";                                
                                    }   
                                    ?>
