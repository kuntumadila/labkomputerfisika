    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                ?>
                    <div class="col-lg-12">
                        <h1 class="page-header">Input Absen Praktikan</h1>
                            ...
                            while ($row2 = mysql_fetch_array($query2)) {
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="id<?php echo "$y"; ?>" type="text" value="<?php $z= $row2['Nim'];echo "$z "; ?>" readonly="" size="5%">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Status : </label>
                                        <select class="form-control" name="status<?php echo "$y"; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="keterangan<?php echo "$y"; ?>" value="" type="text">
                                    </div>
                                </div>    
                            <br>
                            <?php $y++; }?>
